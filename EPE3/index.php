...
<html lang="es">
	<head>
		<meta charset="utf-8">
		<title>Servicios de Turismo | Inicio</title>
				...
				<div class="carousel slide col-8" data-ride="carousel">
					<div class="carousel-inner">
						<div class="carousel-item active">
						  <img src="Imagenes/brasil.jpg" class="d-block w-100">
						</div>
						<div class="carousel-item">
						  <img src="Imagenes/francia.jpg" class="d-block w-100">
						</div>
						<div class="carousel-item">
						  <img src="Imagenes/inglaterra.jpg" class="d-block w-100">
						</div>
						<div class="carousel-item">
							<img src="Imagenes/japon.jpg" class="d-block w-100">
						</div>
					</div>
				</div>
				<div class="jumbotron col-4">
					<h2>Bienvenidos a la EPE 3</h2>
				</div>
			</div>
		</div>
